...
/**
 * Migração opcional para materializar `unlocked` nos usuários existentes.
 *
 * O sistema também possui sincronização preguiçosa ao carregar o progresso,
 * então este script não é obrigatório para novos usuários. Ele é útil para
 * deixar a base inteira consistente imediatamente após a mudança.
 */
