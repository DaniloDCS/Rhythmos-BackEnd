...
import { IRhythm } from "../models/ChatBorRhythms";
...
export const createRhythm = async (req: Request, res: Response) => {
  try {
    ...
    console.error(error);
    return res.status(500).json({ error: "Erro ao criar ritmo" });
  }
};
...
export const createAllRhythm = async (req: Request, res: Response) => {
  try {
...
export const getAllRhythms = async (_: Request, res: Response) => {
  try {
    ...
    console.error(error);
    return res.status(500).json({ error: "Erro ao buscar ritmos" });
  }
};
...
export const getRhythmById = async (req: Request, res: Response) => {
  try {
    ...
    console.error(error);
    return res.status(500).json({ error: "Erro ao buscar ritmo" });
  }
};
...
export const updateRhythm = async (req: Request, res: Response) => {
  try {
    ...
    console.error(error);
    return res.status(500).json({ error: "Erro ao atualizar ritmo" });
  }
};
...
export const deleteRhythm = async (req: Request, res: Response) => {
  try {
    ...
    console.error(error);
    return res.status(500).json({ error: "Erro ao excluir ritmo" });
  }
};
