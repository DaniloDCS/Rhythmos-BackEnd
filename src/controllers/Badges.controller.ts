...
export const createBadge = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({
      error: err instanceof Error ? err.message : "Erro ao criar insígnia",
    });
  }
};
...
export const getAllBadgesAdmin = async (_: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({ error: "Erro ao buscar insígnias" });
  }
};
...
export const getBadgeByIdAdmin = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({ error: "Erro ao buscar insígnia" });
  }
};
...
export const updateBadgeAdmin = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({
      error: err instanceof Error ? err.message : "Erro ao atualizar insígnia",
    });
  }
};
...
export const deleteBadgeAdmin = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({ error: "Erro ao excluir insígnia" });
  }
};

export const getActiveBadges = async (_: Request, res: Response) => {
  try {
    ...
    console.error("Erro ao buscar insígnias ativas:", err);
    return res.status(500).json({ error: "Erro ao buscar insígnias ativas" });
  }
};
