 ...
 *
 * Neste momento o endpoint lê as coleções necessárias uma vez e monta
 * todas as métricas em uma única resposta. Para o volume atual do Rhythmos
 * isso evita vários requests no frontend e mantém as regras de contagem
 * centralizadas no backend.
 *
 * Quando a base crescer bastante, podemos trocar as leituras completas
 * por agregações/counters materializados.
 */
...
const buildLastSevenDays = () => {
  ...
  /*
   * Meio-dia reduz problemas de mudança de dia ao converter para
   * America/Sao_Paulo.
   */
  const now = new Date();
...
export const getAdminDashboard = async (_req: Request, res: Response) => {
  try {
    ...
    /*
     * Aqui "trilhas" representa conclusões de trilha,
     * não apenas cadastros de trilhas pelo administrador.
     */
    enrollments
